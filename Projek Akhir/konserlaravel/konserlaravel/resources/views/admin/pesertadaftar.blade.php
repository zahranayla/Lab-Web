...
@section('page-content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="{{ url('admin/eventdaftar') }}" class="btn btn-sm btn-secondary shadow-sm float-right pull-right">
                        ...
                        <tbody>
                            @foreach ($peserta as $key => $p)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/pesertadetail/' . $p->idpesertaevent) }}" class="btn btn-info">Detail</a>
                                         <a href="{{ url('admin/pesertahapus/' . $p->idpesertaevent) }}" class="btn btn-danger"
